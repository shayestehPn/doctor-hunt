  ...
  getData(){
    ...
    doctorsList.add(
      DoctorModelForFindDoctors(
          ...
          yearsOfExperience: "6",
          satisfyPercent: 89,
          nextAvailableDate: DateModel(year: '2023', month: 'March', day: '23'),
    ...
    doctorsList.add(
      DoctorModelForFindDoctors(
          ...
          yearsOfExperience: "9",
          satisfyPercent: 79,
          nextAvailableDate: DateModel(year: '2023', month: 'May', day: '7'),
    ...
    doctorsList.add(
      DoctorModelForFindDoctors(
          ...
          yearsOfExperience: "1",
          satisfyPercent: 60,
          nextAvailableDate: DateModel(year: '2023', month: 'July', day: '20'),
    ...
    return FindDoctorsDto(doctorsList: doctorsList);
  }
